        ...
        Term.NewAnonymous(
          Template(
            ...
            List(Defn.Def(
              ...
              Some(Type.Name("Json")),
              Term.Apply(Term.Select(Term.Name("Json"), Term.Name("fromString")),
        ...
        Term.NewAnonymous(
          Template(
            ...
            List(Defn.Def(
              ...
              Some(Type.Apply(Type.Select(Term.Name("Decoder"), Type.Name("Result")),
                              List(Type.Name(name)))),
              Term.Block(List(Term.Apply(
                Term.Select(Term.ApplyType(Term.Select(Term.Select(Term.Name("c"),
                                                                   Term.Name("value")),
                                                       Term.Name("as")),
                ...
                List(Term.Block(List(Term.Function(
                  ...
                  Term.Apply(
                    Term.Select(Term.Apply(Term.Select(Term.Name(name), Term.Name("valueOf")),
                                           List(Term.Name("s"))),
                                Term.Name("toRight")),
                    List(Term.Apply(
                      ...
                      List(
                        Term.ApplyInfix(
                          ...
                          Nil,
                          List(
                            Lit.String(s" did not match any of the supported values for $name"))),
      ...
      Defn.Val(
        ...
        Term.NewAnonymous(
          Template(
            Nil,
            List(
              Init(Type.Apply(Type.Name("Encoder"), List(Type.Singleton(Term.Name(name)))),
                   Name(""),
                   Nil)),
            Self(Name(""), None),
            List(Defn.Def(
      ...
      Defn.Val(
        ...
        Term.NewAnonymous(
          Template(
            Nil,
            List(
              Init(Type.Apply(Type.Name("Decoder"), List(Type.Singleton(Term.Name(name)))),
                   Name(""),
                   Nil)),
            Self(Name(""), None),
            List(Defn.Def(
              ...
              Term.Block(List(Term.Apply(
                Term.Select(Term.ApplyType(Term.Select(Term.Name("c"), Term.Name("as")),
                                           List(Type.Name("String"))),
                            Term.Name("flatMap")),
                List(Term.PartialFunction(List(
                  Case(Term.Select(Term.Name(name), Term.Name("value")),
                       None,
                      ...
                      List(Term.Apply(
                        ...
                        List(
                          Term.ApplyInfix(
                            ...
                            Nil,
                            List(Lit.String(
                              s" did not match any of the supported values for $name"))),
                          Term.Select(Term.Name("c"), Term.Name("history"))
                        )
                      ))
                    )
